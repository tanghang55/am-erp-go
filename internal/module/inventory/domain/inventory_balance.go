...
type InventoryBalance struct {
	...
	SellableReserved  uint   `json:"sellable_reserved" gorm:"column:sellable_reserved;not null;default:0"`
	...
	PendingShipmentReserved uint `json:"pending_shipment_reserved" gorm:"column:pending_shipment_reserved;not null;default:0"` // 待出锁定库存
